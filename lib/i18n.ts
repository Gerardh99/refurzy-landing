...
export const translations = {
  ...
  'how.subtitle': {
    nl: 'Drie rollen, één platform. Elke stap is ontworpen om werving kwalitatiever, objectiever en stukken goedkoper te maken.',
    en: 'Three roles, one platform. Every step is designed to make recruitment higher quality, more objective and significantly more affordable.'
  },
  ...
  'faq.a8': {
    nl: 'Ja. Refurzy werkt op basis van no cure, no pay — u betaalt dus nooit voor een kandidaat die u niet aanneemt. Daarbovenop bieden wij de Fit Garantie: bij een M-Score van 80% of hoger en vertrek binnen 12 maanden dat aantoonbaar het gevolg is van een mismatch op cultuur-, waarden- of organisatiefit, leveren wij eenmalig een vervangende kandidaat zonder nieuwe plaatsingsfee. Niet gedekt: functioneringsproblemen, persoonlijke omstandigheden, extern aanbod, gewijzigde functie-inhoud, mismanagement, reorganisatie, ziekte, en situaties waarin de Matching Scan-input van de opdrachtgever niet overeenkomt met de praktijk. Refurzy voert altijd een exitgesprek met de medewerker — zonder dit gesprek vervalt de claim. Het eindoordeel ligt bij Refurzy.',
    en: 'Yes. Refurzy works on a no cure, no pay basis — so you never pay for a candidate you don\'t hire. On top of that, we offer the Fit Guarantee: with an M-Score of 80% or higher, if departure within 12 months is demonstrably caused by a mismatch on culture, values, or organizational fit, we provide a one-time replacement candidate at no additional placement fee. Not covered: performance issues, personal circumstances, external offers, changed job content, mismanagement, reorganization, illness, and situations where the employer\'s Matching Scan input does not reflect actual practice. Refurzy always conducts an exit interview with the employee — without this interview the claim lapses. The final judgment lies with Refurzy.'
  },
