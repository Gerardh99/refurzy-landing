...
export const translations = {
  ...
  'faq.a8': {
    nl: 'Ja. Refurzy werkt op basis van no cure, no pay — u betaalt dus nooit voor een kandidaat die u niet aanneemt. Daarbovenop bieden wij de Fit Garantie: neemt u een kandidaat aan met een M-Score van 80% of hoger en vertrekt deze binnen 12 maanden — ook op eigen initiatief — dan leveren wij gratis een vervangende kandidaat. U betaalt hiervoor geen nieuwe plaatsingsfee. De garantie is alleen niet geldig als: (1) de werkzaamheden afwijken van de vacatureomschrijving, (2) er sprake is van aantoonbaar mismanagement, of (3) de functie verdwijnt door een reorganisatie. Wij durven dit aan te bieden omdat de wetenschap aantoont dat een hoge M-Score samenhangt met significant hogere retentie.',
    en: 'Yes. Refurzy works on a no cure, no pay basis — so you never pay for a candidate you don\'t hire. On top of that, we offer the Fit Guarantee: if you hire a candidate with an M-Score of 80% or higher and they leave within 12 months — including voluntary resignation — we provide a replacement candidate free of charge. You pay no new placement fee. The guarantee only does not apply if: (1) job activities deviate from the vacancy description, (2) there is demonstrable mismanagement, or (3) the position disappears due to reorganization. We dare to offer this because science shows that a high M-Score correlates with significantly higher retention.'
  },
