    ...
    <div className="min-h-screen bg-slate-100 text-slate-900 font-[Poppins]">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/95 backdrop-blur-md border-b border-slate-300 shadow-md">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between relative">
          <Link href="/homepage">
            <img src="/logo-dark.jpg" alt="Refurzy" className="h-7" />
          </Link>
          <div className="hidden md:flex items-center gap-6 text-sm text-slate-600 absolute left-1/2 -translate-x-1/2">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-slate-600 font-normal mb-2 mt-6">
          ...
          <p className="text-base md:text-lg text-slate-600 font-normal max-w-2xl mx-auto mb-4 leading-relaxed">
            {t('hero.sub1', lang)}
          </p>
          ...
          {/* Trust indicators */}
          <div className="flex items-center justify-center gap-8 text-sm text-slate-600 mb-4">
      ...
      <section className="py-24">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">{t('problem.subtitle', lang)}</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={pain.title} className="bg-white shadow-md rounded-2xl border border-slate-300 p-6 hover:border-orange/30 hover:shadow-lg transition-all group">
                ...
                <p className="text-sm text-slate-600 leading-relaxed mb-2">{pain.desc}</p>
                {pain.source && <p className="text-[10px] text-slate-600 italic">{pain.source}</p>}
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="hoe-het-werkt" className="py-24">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-xl mx-auto">{t('how.subtitle', lang)}</p>
          </div>
      ...
      <section id="voor-wie" className="py-24 bg-slate-100">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">{t('solution.subtitle', lang)}</p>
          </div>
            ...
            {[
              ...
              <div key={usp.title} className="bg-white shadow-md rounded-2xl border border-slate-300 p-6 flex gap-5 hover:border-cyan/30 hover:shadow-lg transition-all">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed mb-1">{usp.desc}</p>
                  {usp.source && <p className="text-[10px] text-slate-600 italic">{usp.source}</p>}
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-white shadow-md rounded-2xl border border-cyan/20 p-8 text-center hover:border-cyan/30 hover:shadow-lg transition-all">
              ...
              <p className="text-[10px] text-slate-600 italic">Aberdeen Group, 2015 · Gallup</p>
            </div>
            ...
            <div className="bg-white shadow-md rounded-2xl border border-slate-300 p-8 text-center hover:border-purple/30 hover:shadow-lg transition-all">
              ...
              {showMisHireDetail && (
                <div className="mt-2 text-xs text-slate-600 space-y-1 text-left">
              ...
              <p className="text-[10px] text-slate-600 italic">SHRM, 2024 · Kristof-Brown et al., 2005</p>
            </div>
            ...
            <div className="bg-white shadow-md rounded-2xl border border-orange/20 p-8 text-center hover:border-orange/30 hover:shadow-lg transition-all">
              ...
              <p className="text-[10px] text-slate-600 italic">Halbesleben & Wheeler, 2008 · VU Amsterdam, 2026</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-slate-100 rounded-xl border border-slate-300 p-4 text-center">
              ...
              <p className="text-[9px] text-slate-600 mt-1">SHRM, 2024</p>
            </div>
            <div className="bg-slate-100 rounded-xl border border-slate-300 p-4 text-center">
              ...
              <p className="text-[9px] text-slate-600 mt-1">VU Amsterdam, 2026</p>
            </div>
            <div className="bg-slate-100 rounded-xl border border-slate-300 p-4 text-center">
              ...
              <p className="text-[9px] text-slate-600 mt-1">SHRM, 2025</p>
            </div>
            <div className="bg-slate-100 rounded-xl border border-slate-300 p-4 text-center">
              ...
              <p className="text-[9px] text-slate-600 mt-1">SHRM, 2024 · N=11.080</p>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="bg-gradient-to-r from-cyan/10 via-[#06BAFF]/10 to-purple/10 rounded-3xl border border-cyan/20 p-10 md:p-16">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-[10px] text-slate-600 mt-4 italic">{t('scan.footnote', lang)}</p>
              </div>
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            <div className="bg-white shadow-md rounded-2xl border border-slate-300 p-6 text-center">
              ...
              <p className="text-sm text-slate-600">{t('scan.stat1.label', lang)}</p>
              <p className="text-[10px] text-slate-600 mt-2">{t('scan.stat1.sub', lang)}</p>
            </div>
            <div className="bg-white shadow-md rounded-2xl border border-slate-300 p-6 text-center">
              <div className="text-3xl font-bold text-purple mb-2">39–59%</div>
              <p className="text-sm text-slate-600">{t('scan.stat2.label', lang)}</p>
              <p className="text-[10px] text-slate-600 mt-2">{t('scan.stat2.sub', lang)}</p>
            </div>
            <div className="bg-white shadow-md rounded-2xl border border-slate-300 p-6 text-center">
              <div className="text-3xl font-bold text-orange mb-2">r = −.35</div>
              <p className="text-sm text-slate-600">{t('scan.stat3.label', lang)}</p>
              <p className="text-[10px] text-slate-600 mt-2">{t('scan.stat3.sub', lang)}</p>
            </div>
          </div>
          ...
          <div className="mt-12 bg-white shadow-md rounded-2xl border border-slate-300 p-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="border border-red-500/20 rounded-xl p-5 bg-red-500/5">
                ...
                <p className="text-[10px] text-slate-600 mt-3 italic">SHRM 2025 · Leadership IQ</p>
              </div>
              <div className="border border-cyan/20 rounded-xl p-5 bg-cyan/5">
                ...
                <p className="text-[10px] text-slate-600 mt-3 italic">VU Amsterdam · SHRM · Aberdeen Group</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-300">
                  <th className="text-left py-3 px-4 text-slate-600 font-medium">{t('pricing.colExp', lang)}</th>
                  <th className="text-center py-3 px-4 text-slate-600 font-medium">MBO</th>
                  <th className="text-center py-3 px-4 text-slate-600 font-medium">HBO</th>
                  <th className="text-center py-3 px-4 text-slate-600 font-medium">WO</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={row.exp} className="border-b border-slate-300">
                    <td className="py-3 px-4 text-slate-600 font-medium">{row.exp}</td>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600 text-lg font-semibold">&euro;</span>
                  <input
                    type="text"
                    inputMode="numeric"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <span className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-600 text-lg font-semibold">%</span>
                </div>
            ...
            <div className="bg-gradient-to-br from-cyan/10 via-[#06BAFF]/10 to-purple/10 rounded-3xl border border-cyan/20 p-8 flex flex-col justify-center">
              ...
              <div className="text-center mb-8">
                <p className="text-sm text-slate-600 mb-3 uppercase tracking-wider font-medium">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="text-center">
                  ...
                  <p className="text-[11px] text-slate-600 mt-1">Return on Investment</p>
                </div>
                <div className="text-center">
                  <div className="text-lg font-bold text-slate-900">{formatEur.format(Math.round(calcResults.directeBesparing))}</div>
                  <p className="text-[11px] text-slate-600 mt-1">{lang === 'nl' ? 'besparing op bureau fees' : 'savings on agency fees'}</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-[11px] text-slate-600 mt-1">{lang === 'nl' ? 'cumulatief over 5 jaar' : 'cumulative over 5 years'}</p>
                </div>
              </div>

              {/* Footnote */}
              <p className="text-[10px] text-slate-600 text-center leading-relaxed mb-6">
                {lang === 'nl'
              ...
              <div className="mt-4 text-center">
                ...
                {showCalcDetail && (
                  <div className="mt-3 bg-white rounded-xl border border-slate-300 p-4 text-left text-xs text-slate-600 space-y-1.5">
                    <p className="text-slate-600 font-medium">Een mis-hire kost 50–200% van het jaarsalaris + werkgeverslasten (SHRM). Dit is opgebouwd uit:</p>
                    <ul className="list-disc list-inside space-y-1">
                      <li><strong className="text-slate-600">Herwervingskosten</strong> — vacature, jobboards, recruiter-tijd, selectieprocedure opnieuw doorlopen</li>
                      <li><strong className="text-slate-600">Verloren productiviteit</strong> — de vertrekkende medewerker presteert weken onder niveau, de positie staat maanden open</li>
                      <li><strong className="text-slate-600">Onboarding en training</strong> — alles wat u investeerde in inwerken, cursussen en begeleiding is verloren</li>
                      <li><strong className="text-slate-600">Managementtijd</strong> — leidinggevenden besteden honderden uren aan coaching en afhandeling</li>
                      <li><strong className="text-slate-600">Teamschade</strong> — verloop ondermijnt moreel en productiviteit. Kennis en relaties verdwijnen</li>
                      <li><strong className="text-slate-600">Ontslagkosten (VSO/transitievergoeding)</strong> — in Nederland gemiddeld 1–3 bruto maandsalarissen extra</li>
                    </ul>
            ...
            {[
              ...
              <div key={i} className="bg-white shadow-md rounded-2xl border border-slate-300 overflow-hidden">
                ...
                >
                  ...
                  <span className={`text-slate-600 transition-transform ${openFaq === i ? 'rotate-45' : ''}`}>+</span>
                </button>
                {openFaq === i && (
                  <div className="px-5 pb-5 text-sm text-slate-600 leading-relaxed border-t border-slate-300 pt-4">
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      <footer className="bg-slate-100 border-t border-slate-300 py-12">
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <img src="/logo-dark.jpg" alt="Refurzy" className="h-6 mb-4 opacity-60" />
              <p className="text-xs text-slate-600 leading-relaxed">
                Redefining Recruitment. Forever.
              </p>
            </div>
            <div>
              <h4 className="text-sm font-semibold text-slate-600 mb-3">{t('footer.platform', lang)}</h4>
              <div className="space-y-2 text-xs text-slate-600">
                <a href="#hoe-het-werkt" className="block hover:text-slate-600 transition-colors">{t('footer.forEmployers', lang)}</a>
                <a href="#hoe-het-werkt" className="block hover:text-slate-600 transition-colors">{t('footer.forScouts', lang)}</a>
                <a href="#hoe-het-werkt" className="block hover:text-slate-600 transition-colors">{t('footer.forCandidates', lang)}</a>
                <a href="#pricing" className="block hover:text-slate-600 transition-colors">{t('nav.pricing', lang)}</a>
              </div>
            </div>
            <div>
              <h4 className="text-sm font-semibold text-slate-600 mb-3">{t('footer.company', lang)}</h4>
              <div className="space-y-2 text-xs text-slate-600">
                <a href="#hoe-het-werkt" className="block hover:text-slate-600 transition-colors">{t('footer.about', lang)}</a>
                <Link href="/wetenschap" className="block hover:text-slate-600 transition-colors">{t('footer.science', lang)}</Link>
                <a href="mailto:info@refurzy.com" className="block hover:text-slate-600 transition-colors">{t('footer.contact', lang)}</a>
              </div>
            </div>
            <div>
              <h4 className="text-sm font-semibold text-slate-600 mb-3">{t('footer.legal', lang)}</h4>
              <div className="space-y-2 text-xs text-slate-600">
                <Link href="/juridisch/privacybeleid" className="block hover:text-slate-600 transition-colors">{t('footer.privacy', lang)}</Link>
                <Link href="/juridisch/algemene-voorwaarden" className="block hover:text-slate-600 transition-colors">{t('footer.terms', lang)}</Link>
                <Link href="/juridisch/cookiebeleid" className="block hover:text-slate-600 transition-colors">{t('footer.cookies', lang)}</Link>
              </div>
            </div>
          </div>
