  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-ink-light font-medium mt-1">{scoutKandidaten.length} kandidaten in je netwerk</p>
      </div>
      ...
      <div className="px-6 py-4 space-y-3">
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex flex-wrap gap-2">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-emerald-50 border border-emerald-200 text-xs">
              <span className="text-emerald-700 font-semibold">{k.voorkeursFunctietitel1}</span>
              <span className="text-emerald-500">({k.voorkeursFunctiegebied1})</span>
            </span>
            {k.voorkeursFunctiegebied2 && k.voorkeursFunctietitel2 && (
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-emerald-50 border border-emerald-200 text-xs">
                <span className="text-emerald-700 font-semibold">{k.voorkeursFunctietitel2}</span>
                <span className="text-emerald-500">({k.voorkeursFunctiegebied2})</span>
              </span>
            )}
          </div>
        </div>
