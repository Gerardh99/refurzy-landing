      ...
      <div className="px-6 py-4 space-y-3">
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex flex-wrap gap-2">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-[#14CDD3]/10 border border-[#14CDD3]/25 text-xs">
              <span className="text-[#0EA5A9] font-semibold">{k.voorkeursFunctietitel1}</span>
              <span className="text-[#14CDD3]/70">({k.voorkeursFunctiegebied1})</span>
            </span>
            {k.voorkeursFunctiegebied2 && k.voorkeursFunctietitel2 && (
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-[#14CDD3]/10 border border-[#14CDD3]/25 text-xs">
                <span className="text-[#0EA5A9] font-semibold">{k.voorkeursFunctietitel2}</span>
                <span className="text-[#14CDD3]/70">({k.voorkeursFunctiegebied2})</span>
              </span>
            )}
          </div>
        </div>
