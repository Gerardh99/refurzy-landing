...
const mockClaims: FitGarantieClaim[] = [
  {
    ...
    toelichting: 'Medewerker geeft aan dat de communicatiestijl en teamdynamiek niet overeenkomen met wat in de Matching Scan werd geschetst. Exitgesprek bevestigt cultuurmismatch.',
  ...
  },
  {
    ...
    opmerkingen: [
      ...
      { tekst: 'Exitgesprek met medewerker afgerond. Medewerker bevestigt waardenmismatch. Claim goedgekeurd — vervangende kandidaat wordt geleverd.', datum: '2025-12-22', door: 'Refurzy' },
    ],
  },
  {
    id: 'claim-3',
