...
const texts = {
  nl: {
    ...
    sectors: ['Technologie & Software', 'Financiële Dienstverlening', 'Gezondheidszorg & Farma', 'Transport & Logistiek', 'Onderwijs & Onderzoek', 'Bouw & Vastgoed', 'Detailhandel & E-commerce', 'Energie & Duurzaamheid', 'Horeca & Toerisme', 'Industrie & Productie', 'Juridisch & Consultancy', 'Landbouw & Voeding', 'Media & Entertainment', 'Non-profit & Overheid', 'Telecom & IT-infrastructuur', 'Uitzend & Bemiddeling', 'Zakelijke Dienstverlening', 'Overig'],
  ...
  en: {
    ...
    sectorExpertise: 'Sector expertise *',
    sectors: ['Technology & Software', 'Financial Services', 'Healthcare & Pharma', 'Transport & Logistics', 'Education & Research', 'Construction & Real Estate', 'Retail & E-commerce', 'Energy & Sustainability', 'Hospitality & Tourism', 'Manufacturing & Production', 'Legal & Consulting', 'Agriculture & Food', 'Media & Entertainment', 'Non-profit & Government', 'Telecom & IT Infrastructure', 'Staffing & Recruitment', 'Business Services', 'Other'],
