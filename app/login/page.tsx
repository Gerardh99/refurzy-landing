    ...
    <div className="min-h-screen bg-navy-dark flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 text-sm">Demo Platform</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-navy-light rounded-2xl p-8 border border-purple/20">
          ...
          <button type="submit" className="w-full bg-cyan text-navy-dark font-semibold py-3 rounded-lg hover:bg-cyan-light transition-colors">
            Inloggen
          </button>
