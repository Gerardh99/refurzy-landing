...
const texts = {
  nl: {
    ...
    body: 'Refurzy combineert ervaren recruiters, AI-technologie en wetenschappelijk bewezen matching — ontwikkeld met de Vrije Universiteit Amsterdam. U ontvangt alleen kandidaten die écht passen. Gemiddeld 60% goedkoper. No cure, no pay.³',
  ...
  en: {
    ...
    body: 'Refurzy combines experienced recruiters, AI technology and scientifically proven matching — developed with Vrije Universiteit Amsterdam. You only receive candidates who truly fit. On average 60% cheaper. No cure, no pay.³',
