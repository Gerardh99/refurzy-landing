...
const landingCSS = `
  ...
  .subtitle { font-size:clamp(1.05rem,2.5vw,1.2rem); font-weight:400; text-align:center; color:rgba(249,251,255,0.85); max-width:560px; line-height:1.7; margin-bottom:20px; animation:fadeInUp 0.8s ease-out 0.4s both; }
  .body-text { font-size:clamp(1rem,2vw,1.1rem); font-weight:400; text-align:center; color:rgba(249,251,255,0.8); max-width:520px; line-height:1.7; margin-bottom:16px; animation:fadeInUp 0.8s ease-out 0.5s both; }
