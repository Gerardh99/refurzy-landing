...
const landingCSS = `
  ...
  .body-text { font-size:clamp(0.95rem,2vw,1.05rem); font-weight:400; text-align:center; color:rgba(249,251,255,0.75); max-width:520px; line-height:1.7; margin-bottom:16px; animation:fadeInUp 0.8s ease-out 0.5s both; }
