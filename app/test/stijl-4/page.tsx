// Stijl 4: Warm neutraal — off-white, warme tinten, uitnodigend
export default function Stijl4() {
  return (
    <div className="min-h-screen bg-[#faf9f7] text-[#1c1917] font-[Poppins]">
      {/* Nav */}
      <nav className="fixed top-0 w-full z-50 bg-[#faf9f7]/90 backdrop-blur-md border-b border-[#e7e5e4] shadow-sm">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <img src="/logo-white.png" alt="Refurzy" className="h-7" />
          <div className="flex items-center gap-6 text-sm text-[#78716c]">
            <a className="hover:text-[#1c1917] transition-colors font-medium">Hoe het werkt</a>
            <a className="hover:text-[#1c1917] transition-colors font-medium">Pricing</a>
            <a className="hover:text-[#1c1917] transition-colors font-medium">Wetenschap</a>
          </div>
      ...
      <section className="pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-[#78716c] mb-2 mt-6">Werving gebouwd op wetenschap. Niet op buikgevoel.</p>
          <p className="text-lg text-purple font-semibold mb-8">ROI vanaf 455%. No cure, no pay.</p>
          <p className="text-base text-[#a8a29e] max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <a className="bg-purple/8 text-purple font-semibold px-8 py-4 rounded-xl text-base border border-purple/15 hover:bg-purple/12 transition-colors">Word Talent Scout</a>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-4 gap-6 text-center">
          {[
            ...
            <div key={i}>
              ...
              <div className="text-xs text-[#a8a29e] mt-1">{s.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <p className="text-[#78716c] text-center max-w-2xl mx-auto mb-12">De arbeidsmarkt is drastisch veranderd. De manier waarop we talent werven niet.</p>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl border border-[#e7e5e4] p-6 shadow-sm hover:shadow-md transition-all">
                <div className="text-2xl mb-4">{c.icon}</div>
                <h3 className="font-semibold mb-2">{c.title}</h3>
                <p className="text-sm text-[#78716c] leading-relaxed">{c.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-[#f5f5f4]">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <p className="text-[#78716c] text-center max-w-xl mx-auto mb-12">Drie rollen, één platform.</p>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl border border-[#e7e5e4] p-8 shadow-sm">
      ...
      <footer className="bg-white border-t border-[#e7e5e4] py-8 text-center text-xs text-[#a8a29e]">
        <p className="font-semibold text-lg text-[#1c1917] mb-2">Stijl 4: Warm neutraal</p>
        <p>Off-white achtergrond, warme grijstinten, uitnodigend en professioneel</p>
      </footer>
    </div>
  )
}
