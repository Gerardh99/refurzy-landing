    ...
    <div className="min-h-screen bg-slate-100 text-slate-900 font-[Poppins]">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/95 backdrop-blur-md border-b border-slate-300 shadow-md">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between relative">
          <Link href="/homepage"><img src="/logo-dark.jpg" alt="Refurzy" className="h-7" /></Link>
          <div className="hidden md:flex items-center gap-6 text-sm text-slate-600 absolute left-1/2 -translate-x-1/2">
            <Link href="/homepage#hoe-het-werkt" className="hover:text-slate-900 transition-colors">Hoe het werkt</Link>
            <Link href="/homepage#pricing" className="hover:text-slate-900 transition-colors">Pricing</Link>
            <span className="text-cyan font-medium">Wetenschap</span>
            <Link href="/homepage#faq" className="hover:text-slate-900 transition-colors">FAQ</Link>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-24">
        ...
        <section className="mb-16">
          <div className="bg-purple/5 rounded-2xl border border-purple/20 p-8">
            ...
            <p className="text-slate-600 text-sm text-center mb-6">De 5 redenen waarom Refurzy een betere keuze is dan een traditioneel bureau</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-slate-600 text-sm mb-6 ml-11">De Matching Scan voorspelt bevlogenheid, werkgeluk en retentie. Hieronder de concrete effecten — onderbouwd door onafhankelijk onderzoek.</p>
            ...
            {[
              ...
              <div key={i} className="bg-white shadow-md border border-slate-300 rounded-xl p-4 flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 text-[11px] mt-1.5 italic">Bron: {item.source}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-3 ml-12">
            ...
            {showWetenschapMisHire && (
              <div className="mt-2 bg-white shadow-md border border-slate-300 rounded-xl p-4 text-xs text-slate-600 space-y-1.5">
                <p className="text-slate-600 font-medium">SHRM becijfert de totale kosten van een mis-hire op 50–200% van het jaarsalaris + werkgeverslasten. Bij een bruto maandsalaris van €5.000 bedragen de totale loonkosten €87.480/jaar (€60.000 salaris + €4.800 vakantiegeld + €22.680 werkgeverslasten). 50% daarvan = €44.000, 200% = €175.000. Opgebouwd uit:</p>
                <ul className="list-disc list-inside space-y-1">
                  <li><strong className="text-slate-600">Herwervingskosten</strong> — vacature, jobboards, recruiter-tijd, gehele selectieprocedure opnieuw</li>
                  <li><strong className="text-slate-600">Verloren productiviteit</strong> — de vertrekkende medewerker presteert weken tot maanden onder niveau, de positie staat vervolgens maanden open</li>
                  ...
                  <li><strong className="text-slate-600">Managementtijd</strong> — leidinggevenden besteden honderden uren aan coaching, functioneringsgesprekken en afhandeling</li>
                  <li><strong className="text-slate-600">Teamschade</strong> — verloop ondermijnt het moreel en de productiviteit van het hele team. Kennis en relaties verdwijnen</li>
                  <li><strong className="text-slate-600">Ontslagkosten (VSO/transitievergoeding)</strong> — in Nederland moet bij gedwongen vertrek vaak een vaststellingsovereenkomst worden gesloten, gemiddeld 1–3 bruto maandsalarissen extra</li>
                </ul>
          ...
          <div className="mt-6 bg-purple/5 rounded-xl border border-purple/20 p-5">
            <p className="text-slate-600 text-sm leading-relaxed text-center font-medium">
              Kort gezegd: medewerkers die passen bij uw organisatie zijn <span className="text-cyan">productiever</span>, <span className="text-cyan">gelukkiger</span> en <span className="text-cyan">blijven langer</span> — en dat bespaart <span className="text-slate-900 font-bold">&euro;44.000&ndash;&euro;175.000</span> per voorkomen mis-hire (o.b.v. bruto maandsalaris &euro;5.000).
            </p>
          </div>
        </section>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-300">
                  <th className="text-left px-6 py-4 text-slate-600 font-medium"></th>
                  <th className="text-center px-6 py-4 text-slate-600 font-medium">Traditioneel bureau</th>
              ...
              <tbody className="text-slate-600">
                <tr className="border-b border-slate-300">
                  ...
                  <td className="px-6 py-3 text-center text-red-600">20–30% bruto jaarsalaris<br/><span className="text-[10px] text-slate-600">gem. &euro;16.000</span></td>
                  <td className="px-6 py-3 text-center text-cyan">Vast tarief<br/><span className="text-[10px] text-slate-600">gem. &euro;4.333</span></td>
                </tr>
                <tr className="border-b border-slate-300">
                ...
                <tr className="border-b border-slate-300">
                  ...
                  <td className="px-6 py-3 text-center text-red-600">Retainer verplicht<br/><span className="text-[10px] text-slate-600">kwijt bij eigen match</span></td>
                  <td className="px-6 py-3 text-center text-cyan">No cure, no pay<br/><span className="text-[10px] text-slate-600">geen retainer</span></td>
                </tr>
                <tr className="border-b border-slate-300">
                  <td className="px-6 py-3">Exclusiviteit</td>
                  <td className="px-6 py-3 text-center text-red-600">Vaak verplicht<br/><span className="text-[10px] text-slate-600">je zit vast aan het bureau</span></td>
                  <td className="px-6 py-3 text-center text-cyan">Niet verplicht<br/><span className="text-[10px] text-slate-600">vrij om parallel te werven</span></td>
                </tr>
                <tr className="border-b border-slate-300">
                  <td className="px-6 py-3">Voorspelling van werkgeluk</td>
                  <td className="px-6 py-3 text-center text-slate-600">Niet gemeten</td>
                  <td className="px-6 py-3 text-center text-cyan">M-Score (0–100%)</td>
                </tr>
                <tr>
                  <td className="px-6 py-3">Fit Garantie</td>
                  <td className="px-6 py-3 text-center text-slate-600">Zelden</td>
        ...
        <section className="mb-16">
          ...
          <div className="bg-white shadow-md border border-slate-300 rounded-2xl p-8">
            <p className="text-slate-600 leading-relaxed mb-4">
              De Matching Scan meet hoe goed een kandidaat bij uw organisatie past — niet op basis van cv of ervaring, maar op <strong className="text-slate-900">waarden, interesses en cultuur</strong>. Dit heet in de wetenschap &quot;Person-Organization fit&quot;: de compatibiliteit tussen persoon en organisatie.
            </p>
        ...
        <section className="mb-16">
          ...
          <p className="text-slate-600 mb-6">De scan bestaat uit 35 vragen verdeeld over vier categorieën. Drie daarvan worden gebruikt voor matching. Gevalideerd door de VU Amsterdam bij 309 werknemers (2026).</p>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={dim.title} className={`bg-white shadow-md border rounded-2xl ${dim.color === 'gray' ? 'border-slate-300' : 'border-slate-300'} p-6`}>
                <h3 className={`font-semibold mb-2 ${dim.color === 'cyan' ? 'text-cyan' : dim.color === 'purple' ? 'text-purple' : dim.color === 'orange' ? 'text-orange' : 'text-slate-600'}`}>{dim.title}</h3>
                <p className="text-sm text-slate-600 mb-3 leading-relaxed">{dim.desc}</p>
                <div className="bg-slate-100 rounded-lg p-3 text-xs text-slate-600 space-y-1">
                  <p><span className="text-slate-600 font-medium">Resultaat:</span> {dim.stats}</p>
                  {dim.regression && <p><span className="text-slate-600 font-medium">Na correctie:</span> {dim.regression}</p>}
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="mb-16">
          ...
          <div className="bg-purple/5 rounded-2xl border border-purple/20 p-8">
            <p className="text-slate-600 leading-relaxed mb-6">
              Zowel de organisatie als de kandidaat vullen dezelfde 35 vragen in (~15 minuten). Het systeem berekent hoe goed beide profielen op elkaar aansluiten. Het resultaat is de <strong className="text-slate-900">M-Score</strong>: een percentage van 0–100% dat aangeeft hoe goed de match is.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-100 rounded-xl p-5 text-center">
                ...
                <p className="text-xs text-slate-600">Zeer sterke voorspeller&#xB9;</p>
              </div>
              <div className="bg-slate-100 rounded-xl p-5 text-center">
            ...
            <div className="bg-slate-100 rounded-xl p-5">
              <p className="text-sm text-slate-600 leading-relaxed">
                <strong className="text-slate-900">Wat betekent dit concreet?</strong> Een hogere M-Score betekent dat een kandidaat beter past bij uw organisatie. Dit voorspelt dat hij of zij gelukkiger, productiever en langer bij u zal werken. Het werkt beter dan traditionele selectiemethoden zoals cv-screening of ongestructureerde interviews.&#xB9;
              </p>
              <p className="text-[10px] text-slate-600 mt-3 italic">&#xB9; Onderzocht bij 309 werknemers door de VU Amsterdam (2026). Effect blijft na correctie voor leeftijd, opleiding, salaris en dienstjaren. Ter vergelijking: traditionele capaciteitstests voorspellen werkprestaties met r = .16 (Sackett et al., 2024).</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="bg-white shadow-md border border-slate-300 rounded-2xl p-8 mb-6">
            <h3 className="text-slate-900 font-semibold mb-4">Van vacature tot match in 4 stappen</h3>
            <div className="space-y-4">
              {[
          ...
          <div className="bg-white shadow-md border border-slate-300 rounded-2xl p-8">
            <h3 className="text-slate-900 font-semibold mb-4">Het verschil: weten voor je aanneemt</h3>
            <p className="text-slate-600 text-sm leading-relaxed mb-4">
              Normaal ontdek je pas na maanden of iemand echt bij je organisatie past. Dan is het te laat — 46% van alle aannames faalt binnen 18 maanden (Leadership IQ). Met Refurzy weet u dit <strong className="text-slate-900">voor</strong> de aanname.
            </p>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-slate-100 rounded-xl p-4">
                <p className="text-cyan font-semibold text-sm mb-2">Betere selectie</p>
                <p className="text-slate-600 text-xs leading-relaxed">U besteedt uw tijd aan kandidaten die echt passen. Kandidaten met een lage match worden eruit gefilterd voordat u ze spreekt.</p>
              </div>
              <div className="bg-slate-100 rounded-xl p-4">
                <p className="text-cyan font-semibold text-sm mb-2">Minder twijfel</p>
                <p className="text-slate-600 text-xs leading-relaxed">81% van hiring managers twijfelt bij aannames (Resume Genius, 2024). De M-Score geeft een objectief antwoord naast uw eigen gevoel.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              <div key={v.title} className="bg-white shadow-md border border-slate-300 rounded-2xl p-6">
                <h3 className="text-slate-900 font-semibold mb-2 text-sm">{v.title}</h3>
                <p className="text-slate-600 text-xs leading-relaxed mb-2">{v.desc}</p>
                <p className="text-xs text-slate-600 italic">{v.source}</p>
              </div>
            ))}
          </div>
          ...
          <div className="mt-6 bg-white shadow-md border border-slate-300 rounded-2xl p-6">
            <h3 className="text-slate-900 font-semibold mb-2 text-sm">Internationaal bevestigd: P-O fit vermindert vertrekintentie via zingeving</h3>
            ...
            <p className="text-xs text-slate-600 italic">Wnuk & Chudzicka-Czupala, 2026 (N=1.071)</p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="bg-white shadow-md border border-slate-300 rounded-2xl p-6 mb-6">
            <p className="text-slate-600 text-sm leading-relaxed mb-4">
              De financiële impact van Refurzy komt uit <strong className="text-slate-900">twee bronnen</strong>:
            </p>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-slate-100 rounded-xl border border-cyan/20 p-4">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-cyan text-lg">📉</span>
                  <h4 className="text-slate-900 font-semibold text-sm">Minder mis-hires</h4>
                </div>
              ...
              <div className="bg-slate-100 rounded-xl border border-cyan/20 p-4">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-cyan text-lg">💰</span>
                  <h4 className="text-slate-900 font-semibold text-sm">Lagere wervingskosten</h4>
                </div>
                <p className="text-slate-600 text-xs leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white shadow-md border border-slate-300 rounded-2xl p-8">
              <h3 className="text-slate-900 font-semibold mb-1">Middelgroot bedrijf</h3>
              <p className="text-slate-600 text-xs mb-4">100 medewerkers · 13,5% turnover · gemiddeld salaris €5.000/mnd</p>
              <div className="space-y-3 text-sm">
                <div className="flex justify-between"><span className="text-slate-600">Refurzy kosten jaar 1</span><span className="text-slate-900 font-semibold">€58.496</span></div>
                <div className="flex justify-between"><span className="text-slate-600">Netto besparing/jaar (39% reductie)</span><span className="text-cyan font-semibold">€196.000</span></div>
                <div className="flex justify-between"><span className="text-slate-600">Netto besparing/jaar (59% reductie)</span><span className="text-cyan font-semibold">€1.370.000</span></div>
                <div className="border-t border-slate-300 pt-3 flex justify-between"><span className="text-slate-600">Cumulatief over 5 jaar</span><span className="text-slate-900 font-bold">€793.000 – €5.489.000</span></div>
              </div>
            </div>

            <div className="bg-white shadow-md border border-slate-300 rounded-2xl p-8">
              <h3 className="text-slate-900 font-semibold mb-1">Klein bedrijf</h3>
              <p className="text-slate-600 text-xs mb-4">3 hires/jaar · geen interne recruiter · gemiddeld salaris €5.000/mnd</p>
              <div className="space-y-3 text-sm">
                <div className="flex justify-between"><span className="text-slate-600">Traditioneel bureau (3 hires)</span><span className="text-red-600 font-semibold">€48.600/jaar</span></div>
                <div className="flex justify-between"><span className="text-slate-600">Refurzy (3 hires)</span><span className="text-cyan font-semibold">€12.999/jaar</span></div>
                <div className="flex justify-between"><span className="text-slate-600">Netto besparing/jaar</span><span className="text-cyan font-semibold">€59.000 – €178.000</span></div>
                <div className="flex justify-between"><span className="text-slate-600">ROI</span><span className="text-slate-900 font-bold">455% – 1370%</span></div>
                <div className="border-t border-slate-300 pt-3 flex justify-between"><span className="text-slate-600">Cumulatief over 5 jaar</span><span className="text-slate-900 font-bold">€272.000 – €748.000</span></div>
              </div>
            </div>
          </div>
          <p className="text-[10px] text-slate-600 mt-4 italic text-center">Financiële berekeningen opgesteld door Refurzy op basis van industrie-data (SHRM, BLS). Wetenschappelijke validatie door de Vrije Universiteit Amsterdam betreft de Matching Scan en werkuitkomsten, niet de financiële doorrekeningen.</p>
        </section>
        ...
        <section className="mb-16">
          ...
          <p className="text-slate-600 text-sm mb-4">Transparantie is belangrijk. De Matching Scan is een krachtig hulpmiddel, maar geen kristallen bol.</p>
          <div className="bg-white shadow-md border border-slate-300 rounded-2xl p-8">
            <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
              <div>
                <p className="text-slate-900 font-medium mb-1">Een sterke indicator, geen garantie</p>
              ...
              <div>
                <p className="text-slate-900 font-medium mb-1">Gebaseerd op eerlijke antwoorden</p>
              ...
              <div>
                <p className="text-slate-900 font-medium mb-1">Eén persoon vult het organisatieprofiel in</p>
              ...
              <div>
                <p className="text-slate-900 font-medium mb-1">Onderzocht in Nederland</p>
        ...
        <section className="mb-16">
          <div className="bg-purple/5 rounded-2xl border border-purple/20 p-8">
            ...
            <div className="flex justify-center gap-4">
              ...
              <Link href="/homepage#pricing" className="border border-purple/30 text-slate-600 font-semibold px-8 py-4 rounded-[10px] text-base hover:border-purple/50 hover:text-slate-900 transition-all">
                Bekijk tarieven
              </Link>
            </div>
            <p className="text-[10px] text-slate-600 text-center italic mt-6">
          ...
          <div className="bg-white shadow-md border border-slate-300 rounded-2xl p-6">
            <div className="space-y-3">
              {[
                ...
                <p key={i} className="text-sm text-slate-600 leading-relaxed pl-4 border-l-2 border-slate-300">{ref}</p>
              ))}
            </div>
          </div>
        </section>
        ...
        <div className="mt-16 text-center">
          <Link href="/homepage" className="text-slate-600 hover:text-slate-900 text-sm transition-colors">
