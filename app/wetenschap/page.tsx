      ...
      <div className="max-w-4xl mx-auto px-6 pb-24">
        ...
        <section className="mb-16">
          <div className="bg-purple/5 rounded-2xl border border-purple/20 p-8">
            ...
            <p className="text-slate-700 text-sm text-center mb-6">De 5 redenen waarom Refurzy een betere keuze is dan een traditioneel bureau</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-slate-700 text-sm mb-6 ml-11">De Matching Scan voorspelt bevlogenheid, werkgeluk en retentie. Hieronder de concrete effecten — onderbouwd door onafhankelijk onderzoek.</p>
            ...
            {[
              ...
              <div key={i} className="bg-white shadow-md border border-slate-300 rounded-xl p-4 flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-700 text-[11px] mt-1.5 italic">Bron: {item.source}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-3 ml-12">
            ...
            {showWetenschapMisHire && (
              <div className="mt-2 bg-white shadow-md border border-slate-300 rounded-xl p-4 text-xs text-slate-700 space-y-1.5">
                <p className="text-slate-700 font-medium">SHRM becijfert de totale kosten van een mis-hire op 50–200% van het jaarsalaris + werkgeverslasten. Bij een bruto maandsalaris van €5.000 bedragen de totale loonkosten €87.480/jaar (€60.000 salaris + €4.800 vakantiegeld + €22.680 werkgeverslasten). 50% daarvan = €44.000, 200% = €175.000. Opgebouwd uit:</p>
                <ul className="list-disc list-inside space-y-1">
                  <li><strong className="text-slate-700">Herwervingskosten</strong> — vacature, jobboards, recruiter-tijd, gehele selectieprocedure opnieuw</li>
                  <li><strong className="text-slate-700">Verloren productiviteit</strong> — de vertrekkende medewerker presteert weken tot maanden onder niveau, de positie staat vervolgens maanden open</li>
                  ...
                  <li><strong className="text-slate-700">Managementtijd</strong> — leidinggevenden besteden honderden uren aan coaching, functioneringsgesprekken en afhandeling</li>
                  <li><strong className="text-slate-700">Teamschade</strong> — verloop ondermijnt het moreel en de productiviteit van het hele team. Kennis en relaties verdwijnen</li>
                  <li><strong className="text-slate-700">Ontslagkosten (VSO/transitievergoeding)</strong> — in Nederland moet bij gedwongen vertrek vaak een vaststellingsovereenkomst worden gesloten, gemiddeld 1–3 bruto maandsalarissen extra</li>
                </ul>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-300">
                  <th className="text-left px-6 py-4 text-slate-700 font-medium"></th>
                  <th className="text-center px-6 py-4 text-slate-700 font-medium">Traditioneel bureau</th>
              ...
              <tbody className="text-slate-700">
                <tr className="border-b border-slate-300">
                  ...
                  <td className="px-6 py-3 text-center text-red-600">20–30% bruto jaarsalaris<br/><span className="text-[10px] text-slate-700">gem. &euro;16.000</span></td>
                  <td className="px-6 py-3 text-center text-cyan">Vast tarief<br/><span className="text-[10px] text-slate-700">gem. &euro;4.333</span></td>
                </tr>
                <tr className="border-b border-slate-300">
                ...
                <tr className="border-b border-slate-300">
                  ...
                  <td className="px-6 py-3 text-center text-red-600">Retainer verplicht<br/><span className="text-[10px] text-slate-700">kwijt bij eigen match</span></td>
                  <td className="px-6 py-3 text-center text-cyan">No cure, no pay<br/><span className="text-[10px] text-slate-700">geen retainer</span></td>
                </tr>
                <tr className="border-b border-slate-300">
                  <td className="px-6 py-3">Exclusiviteit</td>
                  <td className="px-6 py-3 text-center text-red-600">Vaak verplicht<br/><span className="text-[10px] text-slate-700">je zit vast aan het bureau</span></td>
                  <td className="px-6 py-3 text-center text-cyan">Niet verplicht<br/><span className="text-[10px] text-slate-700">vrij om parallel te werven</span></td>
                </tr>
                <tr className="border-b border-slate-300">
                  <td className="px-6 py-3">Voorspelling van werkgeluk</td>
                  <td className="px-6 py-3 text-center text-slate-700">Niet gemeten</td>
                  <td className="px-6 py-3 text-center text-cyan">M-Score (0–100%)</td>
                </tr>
                <tr>
                  <td className="px-6 py-3">Fit Garantie</td>
                  <td className="px-6 py-3 text-center text-slate-700">Zelden</td>
        ...
        <section className="mb-16">
          ...
          <p className="text-slate-700 mb-6">De scan bestaat uit 35 vragen verdeeld over vier categorieën. Drie daarvan worden gebruikt voor matching. Gevalideerd door de VU Amsterdam bij 309 werknemers (2026).</p>
            ...
            {[
              ...
              <div key={dim.title} className={`bg-white shadow-md border rounded-2xl ${dim.color === 'gray' ? 'border-slate-300' : 'border-slate-300'} p-6`}>
                ...
                <div className="bg-slate-100 rounded-lg p-3 text-xs text-slate-700 space-y-1">
                  <p><span className="text-slate-700 font-medium">Resultaat:</span> {dim.stats}</p>
                  {dim.regression && <p><span className="text-slate-700 font-medium">Na correctie:</span> {dim.regression}</p>}
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="bg-purple/5 rounded-2xl border border-purple/20 p-8">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-100 rounded-xl p-5 text-center">
                ...
                <p className="text-xs text-slate-700">Zeer sterke voorspeller&#xB9;</p>
              </div>
              <div className="bg-slate-100 rounded-xl p-5 text-center">
            ...
            <div className="bg-slate-100 rounded-xl p-5">
              ...
              <p className="text-[10px] text-slate-700 mt-3 italic">&#xB9; Onderzocht bij 309 werknemers door de VU Amsterdam (2026). Effect blijft na correctie voor leeftijd, opleiding, salaris en dienstjaren. Ter vergelijking: traditionele capaciteitstests voorspellen werkprestaties met r = .16 (Sackett et al., 2024).</p>
            </div>
          </div>
        </section>
          ...
          <div className="bg-white shadow-md border border-slate-300 rounded-2xl p-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-slate-100 rounded-xl p-4">
                ...
                <p className="text-slate-700 text-xs leading-relaxed">U besteedt uw tijd aan kandidaten die echt passen. Kandidaten met een lage match worden eruit gefilterd voordat u ze spreekt.</p>
              </div>
              <div className="bg-slate-100 rounded-xl p-4">
                <p className="text-cyan font-semibold text-sm mb-2">Minder twijfel</p>
                <p className="text-slate-700 text-xs leading-relaxed">81% van hiring managers twijfelt bij aannames (Resume Genius, 2024). De M-Score geeft een objectief antwoord naast uw eigen gevoel.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="mt-6 bg-white shadow-md border border-slate-300 rounded-2xl p-6">
            ...
            <p className="text-xs text-slate-700 italic">Wnuk & Chudzicka-Czupala, 2026 (N=1.071)</p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white shadow-md border border-slate-300 rounded-2xl p-8">
              ...
              <p className="text-slate-700 text-xs mb-4">100 medewerkers · 13,5% turnover · gemiddeld salaris €5.000/mnd</p>
              <div className="space-y-3 text-sm">
                <div className="flex justify-between"><span className="text-slate-700">Refurzy kosten jaar 1</span><span className="text-slate-900 font-semibold">€58.496</span></div>
                <div className="flex justify-between"><span className="text-slate-700">Netto besparing/jaar (39% reductie)</span><span className="text-cyan font-semibold">€196.000</span></div>
                <div className="flex justify-between"><span className="text-slate-700">Netto besparing/jaar (59% reductie)</span><span className="text-cyan font-semibold">€1.370.000</span></div>
                <div className="border-t border-slate-300 pt-3 flex justify-between"><span className="text-slate-700">Cumulatief over 5 jaar</span><span className="text-slate-900 font-bold">€793.000 – €5.489.000</span></div>
              </div>
            </div>

            <div className="bg-white shadow-md border border-slate-300 rounded-2xl p-8">
              <h3 className="text-slate-900 font-semibold mb-1">Klein bedrijf</h3>
              <p className="text-slate-700 text-xs mb-4">3 hires/jaar · geen interne recruiter · gemiddeld salaris €5.000/mnd</p>
              <div className="space-y-3 text-sm">
                <div className="flex justify-between"><span className="text-slate-700">Traditioneel bureau (3 hires)</span><span className="text-red-600 font-semibold">€48.600/jaar</span></div>
                <div className="flex justify-between"><span className="text-slate-700">Refurzy (3 hires)</span><span className="text-cyan font-semibold">€12.999/jaar</span></div>
                <div className="flex justify-between"><span className="text-slate-700">Netto besparing/jaar</span><span className="text-cyan font-semibold">€59.000 – €178.000</span></div>
                <div className="flex justify-between"><span className="text-slate-700">ROI</span><span className="text-slate-900 font-bold">455% – 1370%</span></div>
                <div className="border-t border-slate-300 pt-3 flex justify-between"><span className="text-slate-700">Cumulatief over 5 jaar</span><span className="text-slate-900 font-bold">€272.000 – €748.000</span></div>
              </div>
            </div>
          </div>
          <p className="text-[10px] text-slate-700 mt-4 italic text-center">Financiële berekeningen opgesteld door Refurzy op basis van industrie-data (SHRM, BLS). Wetenschappelijke validatie door de Vrije Universiteit Amsterdam betreft de Matching Scan en werkuitkomsten, niet de financiële doorrekeningen.</p>
        </section>
        ...
        <section className="mb-16">
          ...
          <p className="text-slate-700 text-sm mb-4">Transparantie is belangrijk. De Matching Scan is een krachtig hulpmiddel, maar geen kristallen bol.</p>
          <div className="bg-white shadow-md border border-slate-300 rounded-2xl p-8">
        ...
        <section className="mb-16">
          <div className="bg-purple/5 rounded-2xl border border-purple/20 p-8">
            ...
            <p className="text-slate-700 leading-relaxed text-center max-w-3xl mx-auto mb-4">
            ...
            <p className="text-slate-700 leading-relaxed text-center max-w-3xl mx-auto mb-6">
            ...
            <p className="text-[10px] text-slate-700 text-center italic mt-6">
